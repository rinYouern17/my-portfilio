...
const Introduction = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gradient-to-r from-black via-gray-900 to-purple-900 p-8 text-white">
      ...
      <div className="md:w-1/3 flex justify-center md:justify-end mt-8 md:mt-0">
        <img src={profileImage} alt="Profile" className="rounded-full w-96 h-96 object-cover" />
      </div>
    </section>
  );
};
